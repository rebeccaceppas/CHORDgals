...
def response_mtx(c, f, M, N, U):
    ...
    plt.imshow(submtx_upchan)
    plt.title('submtx_upchan')
    plt.show()
...
def get_resampled_profiles(V, S, z, fine_freqs):
    ...
    print('Initiated array to hold resampled profiles...')

    # converting the units
    profile = GalaxyCatalog(V, S, z)
    profile.convert_units()

    print('Converted into cosmological units...')
